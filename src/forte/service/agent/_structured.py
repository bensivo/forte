"""Bounded-retry structured-call helper over :class:`~forte.interface.llm_client.ILlmClient`.
...
all attempts are exhausted it raises :class:`~forte.model.agent.StructuredCallError` chained from
...
def structured_call(
    ...
    *,
    ...
    raises :class:`~forte.model.agent.StructuredCallError` chained from the last exception. On
